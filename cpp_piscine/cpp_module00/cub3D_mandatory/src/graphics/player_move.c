...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/17 14:58:53 by pdubacqu          #+#    #+#             */
/*   Updated: 2023/02/17 14:58:53 by pdubacqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(t_game *game)
{
	...
	game->player->rot_angle += (game->player->turn_dir->x \
		* game->player->turn_speed) * game->mlx->delta_time;
